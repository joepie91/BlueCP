...
<title>{%?PageTitle} - Activate</title>
...
<body>
    ...
    <div class="loginform">
    	<div class="title"> <img src="templates/blue_default/img/logo.png" width="112" height="35" /></div>
		 <div class="body">
		 <br><div align="center"><strong>BlueCP Registration</strong></div><br>
		 <div align="center">Your account is now registered with {%?PageTitle}, before you can login you must confirm your account.
		 We have sent an email to you with details on how to confirm your account.</div>
        </div>
    </div>
